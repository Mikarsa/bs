...
class SiameseNetwork:
    ...
    def modify_data(self):
        ...
        left_x_train = [[self.word_dict.get(char, self.word_dict["UNK"])for char in data] for data in sample_x_left]
        right_x_train = [[self.word_dict.get(char, self.word_dict["UNK"])for char in data] for data in sample_x_right]
        ...
        y_train = np.expand_dims(y_train, 1) # 这里原本是2
